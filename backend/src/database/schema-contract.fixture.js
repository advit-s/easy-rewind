...
const expectedColumns = Object.freeze({
  ...
  sync_device_sequences: ['id', 'profile_id', 'device_id', 'last_sequence', 'created_at', 'updated_at'],
  sync_devices: [
    'id',
    'profile_id',
    'name',
...
const expectedIndexes = Object.freeze({
  ...
  export_runs: [
    namedIndex('idx_export_runs_profile_state', false, false, 'profile_id', 'state', 'created_at', 'id'),
    automaticIndex('sqlite_autoindex_export_runs_1', 'pk', 'id'),
  ],
  flashcards: [
  ...
  import_runs: [
    namedIndex('idx_import_runs_profile_state', false, false, 'profile_id', 'state', 'created_at', 'id'),
    automaticIndex('sqlite_autoindex_import_runs_1', 'pk', 'id'),
  ],
  interactions: [
    namedIndex(
    ...
    namedIndex('idx_interactions_profile_occurred', false, false, 'profile_id', 'deleted_at', 'occurred_at', 'id'),
    automaticIndex('sqlite_autoindex_interactions_1', 'pk', 'id'),
  ],
  item_tags: [
  ...
  jobs: [
    namedIndex('idx_jobs_profile_lease', false, false, 'profile_id', 'state', 'lease_expires_at', 'available_at', 'id'),
    namedIndex(
    ...
    namedIndex('uq_jobs_profile_idempotency', true, true, 'profile_id', 'idempotency_key'),
  ],
  memory_scores: [
    namedIndex(
      'idx_memory_scores_profile_score',
      false,
      false,
      'profile_id',
      'deleted_at',
    ...
    automaticIndex('sqlite_autoindex_memory_scores_1', 'pk', 'id'),
    namedIndex('uq_memory_scores_live_item', true, true, 'profile_id', 'item_id'),
  ],
  migration_runs: [
  ...
  provider_configurations: [
    ...
    automaticIndex('sqlite_autoindex_provider_configurations_1', 'pk', 'id'),
    namedIndex('uq_provider_configurations_live_provider', true, true, 'profile_id', 'provider'),
  ],
  quiz_results: [
  ...
  reminder_deliveries: [
    ...
    namedIndex(
      'uq_reminder_deliveries_device_channel',
      true,
      false,
      'profile_id',
      'reminder_id',
  ...
  sync_acknowledgements: [
    namedIndex('idx_sync_acknowledgements_profile_device', false, false, 'profile_id', 'device_id', 'created_at', 'id'),
    automaticIndex('sqlite_autoindex_sync_acknowledgements_1', 'pk', 'id'),
    namedIndex('uq_sync_acknowledgements_operation', true, false, 'profile_id', 'operation_id'),
  ],
  sync_changes: [
    namedIndex(
    ...
    namedIndex(
      'idx_sync_changes_tombstone_retention',
      false,
      false,
      'profile_id',
      'change_kind',
  ...
  sync_conflicts: [
    namedIndex('idx_sync_conflicts_resolution_change', false, false, 'profile_id', 'resolution_change_id'),
  ...
  sync_device_sequences: [
    automaticIndex('sqlite_autoindex_sync_device_sequences_1', 'pk', 'id'),
    namedIndex('uq_sync_device_sequences_device', true, false, 'profile_id', 'device_id'),
  ],
  sync_devices: [
  ...
  sync_operations: [
    ...
    namedIndex('uq_sync_operations_device_sequence', true, true, 'profile_id', 'device_id', 'device_sequence'),
    namedIndex('uq_sync_operations_profile_id', true, false, 'profile_id', 'id'),
  ],
  sync_snapshots: [
    namedIndex(
      'idx_sync_snapshots_profile_device',
      false,
      false,
      'profile_id',
      'device_id',
    ...
    automaticIndex('sqlite_autoindex_sync_snapshots_1', 'pk', 'id'),
  ],
  tags: [
...
const expectedForeignKeys = Object.freeze({
  ...
  profiles: [],
  provider_configurations: [profileCascade],
  quiz_results: [
    foreignKey('item_id', 'items', 'CASCADE'),
    foreignKey('profile_id', 'items', 'CASCADE', 'profile_id'),
    profileCascade,
  ...
  sync_acknowledgements: [
    foreignKey('device_id', 'sync_devices', 'CASCADE'),
    foreignKey('operation_id', 'sync_operations', 'CASCADE'),
    foreignKey('profile_id', 'sync_operations', 'CASCADE', 'profile_id'),
    foreignKey('profile_id', 'sync_devices', 'CASCADE', 'profile_id'),
    profileCascade,
  ],
  sync_changes: [
  ...
  sync_conflicts: [profileCascade, foreignKey('resolution_change_id', 'sync_changes', 'SET NULL')],
  sync_cursors: [
    foreignKey('device_id', 'sync_devices', 'CASCADE'),
...
const descendingIndexTerms = Object.freeze({
  ...
  idx_export_runs_profile_state: ['created_at'],
  idx_import_runs_profile_state: ['created_at'],
  idx_interactions_profile_item: ['occurred_at'],
  idx_interactions_profile_occurred: ['occurred_at'],
  idx_items_profile_kind: ['updated_at'],
  idx_items_profile_updated: ['updated_at'],
  idx_memory_scores_profile_score: ['score', 'updated_at'],
  idx_notes_profile_item: ['updated_at'],
  idx_provider_configurations_profile_state: ['updated_at'],
...
const partialIndexPredicates = Object.freeze({
  ...
  uq_jobs_profile_idempotency: 'idempotency_key IS NOT NULL',
  uq_memory_scores_live_item: 'deleted_at IS NULL',
  uq_provider_configurations_live_provider: 'deleted_at IS NULL',
  uq_settings_live_key: 'deleted_at IS NULL',
  uq_sync_conflicts_open_entity: "state = 'open'",
  uq_sync_operations_device_sequence: 'device_id IS NOT NULL AND device_sequence IS NOT NULL',
