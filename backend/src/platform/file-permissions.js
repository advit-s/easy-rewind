...
const FILE_PERMISSION_ERROR_MESSAGES = Object.freeze({
  ...
  FILE_PERMISSION_TRUSTED_ROOT_REQUIRED: 'A trusted permission root is required.',
  FILE_PERMISSION_TRUSTED_ROOT_INVALID: 'The trusted permission root must be one exact absolute path.',
  FILE_PERMISSION_TARGET_OUTSIDE_ROOT: 'The permission target must stay within the trusted root.',
  ...
  FILE_PERMISSION_LOCK_UNAVAILABLE: 'A stable locked permission target is required.',
  FILE_PERMISSION_IDENTITY_CHANGED: 'The permission target identity changed during the operation.',
  FILE_PERMISSION_ACL_VERIFICATION_FAILED: 'The restrictive Windows ACL could not be verified.',
